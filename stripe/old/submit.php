...
if(!empty($_POST['stripeToken'])){
    ...
    //set api key
    $stripe = array(
      "secret_key"      => "sk_test_51HZI80H3jdWvr8gErqdNWpqUkAgHMQdw7uug1mfUY38vIUfodsAWj4hoBK43rBvHebYETVX4ZCne03o3Ifco1qkR00dhrdpPsh",
      "publishable_key" => "pk_test_51HZI80H3jdWvr8gEn3oRtFlnJTqRpecXGQueOyngEArTyF6gjjfOVqbFeFMpAMRoQmKwPPrh81OiWzhDlqtS5nGs00gKycg4Oa"
    );
...
['failure_code']) && $chargeJson['paid'] == 1 && $chargeJson['captured'] == 1){
        ...
        $sql = 
"INSERT INTO orders_stripe(name,email,card_num,card_cvc,card_exp_month,card_exp_year,
