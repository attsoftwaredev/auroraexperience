      ...
      <div class="col-xxl-5 col-lg-6 col-md-6">
        <div class="product-gallery">
          ...
          <div class="product-thumbnails insize">
            ...
            <div class="item"><img src="{{asset('public/assets/images/'.$item->photo)}}" alt="zoom"  /></div>
            @foreach ($galleries as $key => $gallery)
            <div class="item"><img src="{{asset('public/assets/images/'.$gallery->photo)}}" alt="zoom"  /></div>
            @endforeach
        </div>
      </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-8">
              ...
              <div class="single-review">
                  <div class="comment">
                    <div class="comment-author-ava"><img class="lazy" data-src="{{asset('public/assets/images/'.$review->user->photo)}}" alt="Comment author"></div>
                    ...
                    <div class="slider-item">
                        <div class="product-card">
                            ...
                            <div class="product-thumb">
                                <img class="lazy" data-src="{{asset('public/assets/images/'.$related->thumbnail)}}" alt="Product">
