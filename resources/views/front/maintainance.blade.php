...
<html>
	<head>
		...
		<!-- favicon -->
		<link rel="shortcut icon" href="{{asset('public/assets/front/img/'.$setting->favicon)}}" type="image/x-icon">
				...
				<div class="row">
					<div class="col-lg-4 offset-lg-4">
						<div class="maintain-img-wrapper">
							<img src="{{asset('public/assets/images/'.$setting->maintainance_image)}}" alt="">
						</div>
					</div>
				</div>
				<div class="row">
