          ...
          <div class="col-xl-9 col-lg-8 order-lg-2">
            <div class="card blog-details-box">
                ...
                <div class="blog-details-slider owl-carousel">
                    ...
                    <img src="{{asset('public/assets/images/'.$photo)}}" alt="Image">
                    @endforeach
                </div>
            ...
            @if($post->category->posts->where('id','!=',$post->id)->count() > 0)
                ...
                <div class="resent-blog-slider owl-carousel" >
                    ...
                    <div class="widget widget-featured-posts">
                        <div class="entry">
                        <div class="entry-thumb"><a href="{{route('front.blog.details',$like_post->slug)}}"><img src="{{asset('public/assets/images/'.json_decode($like_post->photo,true)[array_key_first(json_decode($like_post->photo,true))])}}" alt="Post"></a></div>
          ...
          <div class="col-xl-3 col-lg-4 order-lg-1">
            ...
            <aside class="sidebar sidebar-offcanvas position-left"><span class="sidebar-close"><i class="icon-x"></i></span>
              ...
              <section class="widget widget-featured-posts card rounded p-4 mb-30">
               ...
               <div class="entry">
                <div class="entry-thumb"><a href="{{route('front.blog.details',$recent->slug)}}"><img src="{{ asset('public/assets/images/'.json_decode($recent->photo,true)[array_key_first(json_decode($recent->photo,true))]) }}" alt="Post"></a></div>
                <div class="entry-content">
