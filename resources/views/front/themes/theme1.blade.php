                        ...
                        <div class="hero-slider">
                            <div class="hero-slider-main owl-carousel dots-inside" >
                                @foreach ($sliders as $slider)
                                    ...
                                    @endif
                                    "
                                        style="background: url('{{ asset('public/assets/images/' . $slider->photo) }}')">
                        ...
                        <div class="slider-item">
                            <div class="product-card">
                                <div class="product-thumb">
                                    ...
                                    @endif
                                    <img class="lazy" data-src="{{asset('public/assets/images/'.$compaign_item->item->thumbnail)}}" alt="Product">
                            ...
                            <div class="slider-item">
                                <div class="product-card">
                                    <div class="product-thumb">
                                        ...
                                        @endif
                                            <img class="lazy" data-src="{{asset('public/assets/images/'.$popular_category_item->thumbnail)}}" alt="Product">
                    ...
                    <div class="col-gd">
                        <div class="product-card">
                            <div class="product-thumb" >
                                ...
                                @endif
                                    <img class="lazy" data-src="{{asset('public/assets/images/'.$feature_category_item->thumbnail)}}" alt="Product">
