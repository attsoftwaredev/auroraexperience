                            ...
                            <p>
                              ...
                              @if ($item['item_type'] == 'digital')
                                  @if ($order->payment_status == 'Paid')
                                    ...
                                    @else
                                    <a href="{{asset('public/assets/files/'.$main_item->file)}}" class="btn btn-sm btn-success">{{__('Download')}}</a>
                                    @endif
                                  @endif
                              @endif
                              ...
                              @if ($order->payment_status == 'Paid')
                                  ...
                                  @else
                                  <a href="{{asset('public/assets/files/'.$main_item->file)}}" class="btn my-2 btn-sm btn-success">{{__('Download')}}</a>
                                  <p class="py-2">{{__('License Information')}} : {{$item['item_l_n']}} : {{$item['item_l_k']}}</p>
                                  @endif
                                @endif
                              @endif
