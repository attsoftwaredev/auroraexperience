...
<head>
  ...
  <link rel="stylesheet" media="screen" href="{{asset('public/assets/front/css/vendor.min.css')}}">
...
<!-- Main css -->
<link href="{{ asset('public/assets/front/css/main.css') }}" rel="stylesheet">
</head>
  ...
  <div class="card card-body p-5">
              ...
              <div class="row">
                <div class="col text-center">
                  ...
                  <!-- Logo -->
                  <img class="img-fluid mb-5 mh-70"  alt="Logo" src="{{asset('public/assets/images/'.$setting->logo)}}">
...
<script type="text/javascript" src="{{asset('public/assets/front/js/vendor.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('public/assets/front/js/plugin.js')}}"></script>
