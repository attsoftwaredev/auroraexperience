...
<link href="{{ asset('public/assets/front/css/fontawesome.min.css') }}" rel="stylesheet">
<link href="{{ asset('public/assets/front/css/magnific-popup.css') }}" rel="stylesheet">
<link href="{{ asset('public/assets/front/css/jquery-ui.css') }}" rel="stylesheet">
                ...
                <div class="card">
                    <div class="card-body">
                            <div class="row">
                                ...
                                <!-- Logo -->
                                <img class="img-fluid mb-5 mh-70" width="180" alt="Logo" src="{{asset('public/assets/images/'.$setting->logo)}}">
