...
<div class="container-fluid">
    ...
    <div class="mb-4">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 pl-3 dash-title"><b>{{ __('Categories') }}</b></h3>
                <div>
                <a class="btn btn-primary  btn-sm" href="{{ route('back.faq.index') }}">{{ __('Faqs') }}</a>
                <a class="btn btn-primary  btn-sm addBtn" href="{{route('back.fcategory.create')}}"><i class="fas fa-plus"></i> {{ __('Add') }}</a>
                </div>
        </div>
        </div>
