...
<div class="container-fluid">
    ...
    <div class="mb-4">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title dash-title"><b>{{ __('Subscription Create Category') }}</b> </h3>
			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center"> 
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('back.scategory.store') }}" method="POST"
									...
									<div class="form-group">
                                        ...
                                        <br>
										<img class="admin-img" src="{{  asset('public/assets/images/placeholder.png') }}"
												alt="No Image Found">
                                        <br>
