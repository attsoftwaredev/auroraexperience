...
<div class="container-fluid">
    ...
    <div class="mb-4">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title dash-title"><b>{{ __('Edit Sub Category') }}</b> </h3>
                <a class="btn btn-primary btn-sm addBtn" href="{{route('back.subcategory.index')}}"><i class="fas fa-chevron-left"></i> {{ __('Back') }}</a>
                </div>
    </div>
