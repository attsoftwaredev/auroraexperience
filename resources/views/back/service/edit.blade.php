...
<div class="container-fluid">
    ...
    <div class="mb-4">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h3 class=" mb-0 dash-title"><b>{{ __('Edit Service') }}</b></h3>
            <a class="btn btn-primary btn-sm addBtn" href="{{route('back.service.index')}}"><i class="fas fa-chevron-left"></i> {{ __('Back') }}</a>
            </div>
    </div>
						...
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('back.service.update',$service->id) }}"
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												src="{{ $service->photo ? asset('public/assets/images/'.$service->photo) : asset('public/assets/images/placeholder.png') }}"
												alt="No Image Found">
										<br>
