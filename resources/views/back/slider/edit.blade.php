						...
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('back.slider.update',$slider->id) }}"
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												src="{{ $slider->logo ? asset('public/assets/images/'.$slider->logo) : asset('public/assets/images/placeholder.png') }}"
												alt="No Image Found">
										<br>
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												src="{{ $slider->photo ? asset('public/assets/images/'.$slider->photo) : asset('public/assets/images/placeholder.png') }}"
												alt="No Image Found">
										<br>
