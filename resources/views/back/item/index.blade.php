...
<div class="container-fluid">
    ...
    <div class="mb-4">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title dash-title"><b>{{ __('All Products') }}</b></h3>
                    <div class="right">
                        <a href="{{ route('back.digital.item.create') }}" class="btn btn-info btn-sm d-inline-block"><i class="fas fa-plus"></i>{{__('Add Product')}}</a>
                ...
                <div class="product-filter-area">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mt-2">
                            <button type="submit" class="btn btn-primary  py-2  d-inline-block addBtn">{{__('Filter Product')}}</button>
                        </div>
                    </div>
                </div>
            </form>
