...
<div class="mb-4">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h3 class="mb-0 bc-title dash-title"><b>{{ __('Create Subscription Product') }}</b> </h3>
            <a class="btn btn-primary   btn-sm addBtn" href="{{route('back.item.list')}}"><i class="fas fa-chevron-left"></i> {{ __('Back') }}</a>
        </div>
</div>
...
<form class="admin-form tab-form" action="{{ route('back.subscription.item.store') }}" method="POST"
                enctype="multipart/form-data">
    <input type="hidden" value="subscription" name="item_type">
    @csrf
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="subcategory_id" id="subcategory_id" class="form-control schild_subscription_category">
							...
							<option value="{{ $cats->id }}"  data-id="{{ $cats->category_id }}"  class="child_cat category_child_child{{ $cats->category_id }}  hide">{{ $cats->name }}</option>
							@endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="childcategory_id" id="childcategory_id" class="form-control">
							...
							<option value="{{ $catss->id }}"  data-id="{{ $catss->subcategory_id }}"  class="schild_cat category_child_schild{{ $catss->subcategory_id }}  hide">{{ $catss->name }}</option>
							@endforeach
                        </select>
                    </div>
                    <!-----
