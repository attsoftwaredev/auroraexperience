...
<div class="container-fluid">
    ...
    <div class="mb-4">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title dash-title"><b>{{ __('All Subscription Products') }}</b></h3>
                    <div class="right">
                        <a href="{{ route('back.subscription.item.create') }}" class="btn btn-info btn-sm d-inline-block"><i class="fas fa-plus"></i>{{__('Add Product')}}</a>
	...
	<div class="card shadow mb-4">
		<div class="card-body">
            ...
            <form action="{{route('back.item.list')}}" method="GET">
                <div class="product-filter-area">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <button style="margin-top: 10px;" type="submit" class="btn btn-primary  py-2  d-inline-block addBtn">{{__('Filter Product')}}</button>
                        </div>
                    </div>
