...
<div class="container-fluid">
    ...
    <div class="mb-0">
        ...
        <h3 class="mb-0 bc-title dash-title"><b>{{ __('Update Profile') }}</b></h3>
        <ol class="breadcrumb">
								...
								<form class="admin-form" action="{{ route('back.profile.update') }}" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-lg-12 pb-1">
											<img class="admin-img"
												src="{{ $data->photo ? asset('public/assets/images/'.$data->photo) : asset('public/assets/images/placeholder.png') }}"
												alt="No Image Found">
										</div>
									...
									<div class="form-group">
										<button type="submit" class="btn btn-secondary btn-block submitBtn">{{ __('Submit') }}</button>
									</div>
