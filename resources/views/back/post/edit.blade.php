...
<div class="container-fluid">
    ...
    <div class="mb-4">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class=" mb-0 bc-title dash-title"><b>{{ __('Update Blog') }}</b> </h3>
                <a class="btn btn-primary btn-sm addBtn" href="{{route('back.post.index')}}"><i class="fas fa-chevron-left"></i> {{ __('Back') }}</a>
                </div>
    </div>
                                    ...
                                    <div class="d-block">
                                        ...
                                        @forelse(json_decode($post->photo,true) as $key => $photo)
                                            <div class="single-g-item d-inline-block m-2">
                                                    ...
                                                    <a class="popup-link" href="{{ $photo ? asset('public/assets/images/'.$photo) : asset('public/assets/images/placeholder.png') }}">
                                                        <img class="admin-gallery-img" src="{{ $photo ? asset('public/assets/images/'.$photo) : asset('public/assets/images/placeholder.png') }}"
                                                            alt="No Image Found">
                                                    </a>
                                            </div>
                                        @empty
