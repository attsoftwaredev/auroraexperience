...
<div class="container-fluid">
    ...
    <div class="mb-4">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title dash-title"><b>{{ __('Manage Tickets') }}</b></h3>
                <a class="btn btn-primary btn-sm addBtn" href="{{route('back.ticket.create')}}"><i class="fas fa-plus"></i> {{ __('Add') }}</a>
                </div>
    </div>
