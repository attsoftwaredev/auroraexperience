...
<div class="container-fluid">
    ...
    <div class="mb-4">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title dash-title"><b>{{ __('Edit Ticket') }}</b> </h3>
						...
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('back.ticket.update',$ticket->id) }}" method="POST"
                                    ...
                                    <div class="mb-2">
                                        <div class="card">
                                            <div class="card-body d-flex flex-row justify-content-between ">
                                                ...
                                                <div>
                                                    @if($ticket->file)
                                                <a href="{{asset('public/assets/files/'.$ticket->file)}}" title="Download" class="btn btn-primary btn-sm" download> {{__('Attachment')}}</a>
                                                @endif
                                    ...
                                    @endif
                                        ...
                                        <div class=" mt-3">
                                            <button class="btn btn-primary submitBtn" type="submit">{{__('Reply')}}</button>
                                        </div>
                                        @endif
