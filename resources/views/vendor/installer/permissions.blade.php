...
@section('container')
    ...
    <ul class="list">
        ...
        <li class="list__item list__item--permissions {{ $permission['isSet'] ? 'success' : 'error' }}">
            ...
            bootstrap/cache/
            @elseif ($permission['folder'] == 'public/public/assets/images/')
            public/assets/images/
            @elseif ($permission['folder'] == 'public/assets/sitemaps/')
            assets/sitemaps/
            @elseif ($permission['folder'] == 'public/public/assets/files/')
            public/assets/files/
