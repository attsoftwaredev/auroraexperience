...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        // --------- SUBSCRIPTION PRODUCT -----------//
            Route::get('/subscription/create', 'Back\ItemController@subscriptionItemCreate')->name('back.subscription.item.create');
            Route::post('/subscription/store', 'Back\ItemController@subscriptionItemStore')->name('back.subscription.item.store'); 
            Route::get('/subscription/edit/{id}', 'Back\ItemController@subscriptionItemEdit')->name('back.subscription.item.edit');
             Route::get('item/list', 'Back\ItemController@list')->name('back.item.list');
        ...
        Route::group(['middleware' => 'permissions:Manage Categories'], function () {
            ...
            Route::get('scategory/status/{id}/{status}', 'Back\ScategoryController@status')->name('back.scategory.status');
            Route::get('scategory/feature/{id}/{status}', 'Back\ScategoryController@feature')->name('back.scategory.feature');
            Route::resource('scategory', 'Back\ScategoryController', ['as' => 'back', 'except' => 'show']);

            //------------SUBSCRIPTION SUB CATEGORY ------------
            Route::get('ssubcategory/status/{id}/{status}', 'Back\SsubCategoryController@status')->name('back.ssubcategory.status');
            Route::resource('ssubcategory', 'Back\SsubCategoryController', ['as' => 'back', 'except' => 'show']);

            //------------SUBSCRIPTION CHILD CATEGORY ------------
            Route::get('schildcategory/status/{id}/{status}', 'Back\SchildCategoryController@status')->name('back.schildcategory.status');
            Route::resource('schildcategory', 'Back\SchildCategoryController', ['as' => 'back', 'except' => 'show']);
        });
        ...
        Route::group(['middleware' => 'permissions:Ecommerce'], function () {
            ...
            //------------ DONATION SETTING ------------
            Route::get('/donation/donate', 'Back\DonationSettingController@payment')->name('back.donation.donate');
            Route::get('/donation/list', 'Back\DonationSettingController@list')->name('back.donation.list');
            Route::post('/donation/donate/update', 'Back\DonationSettingController@restr')->name('back.donation.donate.restr');
        ...
        Route::group(['middleware' => 'permissions:Manages Websites'], function () {
            //------------ TICKET ------------
            Route::get('website/status/{id}/{status}', 'Back\WebsiteController@status')->name('back.website.status');
            Route::resource('website', 'Back\WebsiteController', ['as' => 'back', 'except' => 'show']);
        });
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::get('/signin', 'Front\FrontendController@signin')->name('front.signin');
        Route::get('/signup', 'Front\FrontendController@signup')->name('front.signup'); 
        Route::get('/about', 'Front\FrontendController@about')->name('front.about');
        Route::get('/donation', 'Front\FrontendController@donation')->name('front.donation');
        Route::get('/contacts', 'Front\FrontendController@contacts')->name('front.contacts');
        Route::get('/events', 'Front\FrontendController@events')->name('front.events');
        Route::get('/thankyou', 'Front\FrontendController@thankyou')->name('front.thankyou');
        Route::get('/donation-payment', 'Front\FrontendController@donationpayment')->name('front.donation-payment');
            
        Route::post('/thankyou', 'Front\FrontendController@charge')->name('front.donation.submit');
