...
<div class="mb-4">
        <div class="d-sm-flex align-items-center justify-content-between">
            <h3 class="mb-0 bc-title dash-title"><b><?php echo e(__('Update Digital Product')); ?></b> </h3>
            <a class="btn btn-primary   btn-sm addBtn" href="<?php echo e(route('back.item.index')); ?>"><i class="fas fa-chevron-left"></i> <?php echo e(__('Back')); ?></a>
        </div>
</div>
        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <img class="admin-img lg" src="<?php echo e($item->photo ? asset('public/assets/images/'.$item->photo) : asset('public/assets/images/placeholder.png')); ?>" >
                    </div>
                            ...
                            <div class="d-block gallery_image_view">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $item->galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="single-g-item d-inline-block m-2">
                                            ...
                                            <a class="popup-link" href="<?php echo e($gallery->photo ? asset('public/assets/images/'.$gallery->photo) : asset('public/assets/images/placeholder.png')); ?>">
                                                <img class="admin-gallery-img" src="<?php echo e($gallery->photo ? asset('public/assets/images/'.$gallery->photo) : asset('public/assets/images/placeholder.png')); ?>"
                                                    alt="No Image Found">
                                            </a>
                                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group view_file <?php echo e($item->file_type == 'file' ? '' : 'd-none'); ?> ">
                        ...
                        <?php if(file_exists('public/assets/files/'.$item->file)): ?>
                            <a download href="<?php echo e(asset('public/assets/files/'.$item->file)); ?>"><?php echo e(__('Download File')); ?></a>
                        <?php endif; ?>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-secondary mr-2 saveBtn"><?php echo e(__('Save')); ?></button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nzocgvvlkplb/public_html/auroraexperiences.gigvie.com/resources/views/back/item/digital/edit.blade.php ENDPATH**/ ?>