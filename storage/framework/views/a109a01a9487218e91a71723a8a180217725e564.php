...
<tr id="product-bulk-delete">
  <td><input type="checkbox" class="bulk-item" value="<?php echo e($data->id); ?>"></td>
    <td>
        <img src="<?php echo e($data->thumbnail ? asset('public/assets/images/'.$data->thumbnail) : asset('public/assets/images/placeholder.png')); ?>" alt="Image Not Found">
    </td>
    <td>
    ...
    <td>
        <div class="dropdown">
            ...
            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
              ...
              <?php elseif($data->item_type =='subscription'): ?>
              <a class="dropdown-item" href="<?php echo e(route('back.subscription.item.edit',$data->id)); ?>"><i class="fas fa-angle-double-right"></i> <?php echo e(__('Edit')); ?></a>
...
<?php /**PATH /home/nzocgvvlkplb/public_html/auroraexperiences.gigvie.com/resources/views/back/item/table.blade.php ENDPATH**/ ?>