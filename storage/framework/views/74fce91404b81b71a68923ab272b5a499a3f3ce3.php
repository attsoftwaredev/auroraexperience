...
<div class="container-fluid">
    ...
    <div class="mb-4">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class=" mb-0 bc-title dash-title"><b><?php echo e(__('Update Blog')); ?></b> </h3>
                                    ...
                                    <div class="d-block">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = json_decode($post->photo,true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <div class="single-g-item d-inline-block m-2">
                                                    ...
                                                    <a class="popup-link" href="<?php echo e($photo ? asset('public/assets/images/'.$photo) : asset('public/assets/images/placeholder.png')); ?>">
                                                        <img class="admin-gallery-img" src="<?php echo e($photo ? asset('public/assets/images/'.$photo) : asset('public/assets/images/placeholder.png')); ?>"
                                                            alt="No Image Found">
                                                    </a>
                                            </div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nzocgvvlkplb/public_html/auroraexperiences.gigvie.com/resources/views/back/post/edit.blade.php ENDPATH**/ ?>