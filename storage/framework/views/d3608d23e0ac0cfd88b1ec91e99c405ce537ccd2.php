...
<div class="container-fluid">
    ...
    <div class="mb-4">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title dash-title"><b><?php echo e(__('All Subscription Products')); ?></b></h3>
                    <div class="right">
                        <a href="<?php echo e(route('back.subscription.item.create')); ?>" class="btn btn-info btn-sm d-inline-block"><i class="fas fa-plus"></i><?php echo e(__('Add Product')); ?></a>
    ...
    <input type="hidden" id="product_url" value="<?php echo e(route('back.item.list')); ?>">

	<!-- DataTales -->
	<div class="card shadow mb-4">
		<div class="card-body">
            <?php echo $__env->make('alerts.alerts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <form action="<?php echo e(route('back.item.list')); ?>" method="GET">
                <div class="product-filter-area">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6" >
                            <div class="form-group px-0">
                                <select class="form-control" name="category_id">
                                    ...
                                    <?php $__currentLoopData = DB::table('scategories')->whereStatus(1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <button style="margin-top: 10px;" type="submit" class="btn btn-primary  py-2  d-inline-block addBtn"><?php echo e(__('Filter Product')); ?></button>
                        </div>
                    </div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nzocgvvlkplb/public_html/auroraexperiences.gigvie.com/resources/views/back/item/list.blade.php ENDPATH**/ ?>