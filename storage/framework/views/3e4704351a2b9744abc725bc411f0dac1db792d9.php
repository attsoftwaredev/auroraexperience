...
<div class="container-fluid">
    ...
    <div class="mb-4">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title dash-title"><b><?php echo e(__('All Products')); ?></b></h3>
                    <div class="right">
                        <a href="<?php echo e(route('back.digital.item.create')); ?>" class="btn btn-info btn-sm d-inline-block"><i class="fas fa-plus"></i><?php echo e(__('Add Product')); ?></a>
                ...
                <div class="product-filter-area">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mt-2">
                            <button type="submit" class="btn btn-primary  py-2  d-inline-block addBtn"><?php echo e(__('Filter Product')); ?></button>
                        </div>
                    </div>
                </div>
            </form>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nzocgvvlkplb/public_html/auroraexperiences.gigvie.com/resources/views/back/item/index.blade.php ENDPATH**/ ?>