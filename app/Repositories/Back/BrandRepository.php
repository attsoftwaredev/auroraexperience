...
class BrandRepository
{
    ...
    public function update($brand, $request)
    {
        ...
        if ($file = $request->file('photo')) {
            $input['photo'] = ImageHelper::handleUpdatedUploadedImage($file,'/public/assets/images',$brand,'/public/assets/images/','photo');
    ...
    {
        ImageHelper::handleDeletedImage($brand,'photo','public/assets/images/');
        $brand->delete();
    }
