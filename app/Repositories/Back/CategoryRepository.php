...
class CategoryRepository
{
    ...
    public function update($category, $request)
    {
        ...
        if ($file = $request->file('photo')) {
            $input['photo'] = ImageHelper::handleUpdatedUploadedImage($file,'/public/assets/images/',$category,'/public/assets/images/','photo');
        }
    ...
    public function delete($category)
    {
       ...
       if($check){
        ...
        ImageHelper::handleDeletedImage($category,'photo','public/assets/images/');
        $category->delete();
