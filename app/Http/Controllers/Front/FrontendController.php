...
// -------------------------------- SUBSCRIBE ----------------------------------------
    ...
    {
        return redirect(route('front.test'));
    }
	...
	public function donation()
	{
        ...
        return view('front.donation', ['onetime' => $onetime,'monthly' => $monthly]);
	...
	{ 
	    ...
	    $payment_method = $request->stripeTokenType;
	    $token = $request->stripeToken;
	    $donation_note = $request->donation_note;
	    $transaction_type = $request->type_amount;
	    $transaction_number = $request->_token;
