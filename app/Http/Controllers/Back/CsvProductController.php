...
class CsvProductController extends Controller
{
    ...
    public function export()
    {
        ...
        foreach($lists->toArray() as $list){
            $list['photo'] = asset('public/assets/images/'.$list['photo']);
    ...
    public function orderExport()
    {
     ...
     public function import(Request $request)
     {
         ...
         try {
            ...
            while (($line = fgetcsv($file)) !== FALSE) {
                ...
                if($i != 1)
                {
                   ...
                   $fimg->save(public_path().'public/assets/images/'.$fphoto);
                   $input['photo']  = $fphoto;
        ...
        $removefiles = glob(public_path().'public/assets/temp_files/*'); 
