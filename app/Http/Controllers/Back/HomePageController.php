    ...
    public function hero_banner_update(Request $request)
    {
        ...
        foreach($all_images_names as $single_image){
            if($request->hasFile($single_image)){
                ...
                $input[$single_image] = ImageHelper::handleUploadedImage($request->$single_image,'public/assets/images',isset($check[$single_image]) ? $check[$single_image] : null);
            }
        }
    ...
    public function first_banner_update(Request $request)
    {
        ...
        foreach($all_images_names as $single_image){
            if($request->hasFile($single_image)){
                ...
                $input[$single_image] = ImageHelper::handleUploadedImage($request->$single_image,'public/assets/images',$check[$single_image]);
            }else{
                $check = json_decode($data->banner_first,true);
