...
class SitemapController extends Controller
{
    ...
    public function download(Request $request) {
        ...
        return response()->download('public/assets/sitemaps/'.$request->filename);
    }
    ...
    public function store(Request $request)
    {
        ...
        SitemapGenerator::create($request->sitemap_url)->writeToFile('public/assets/sitemaps/' . $filename);
    ...
    public function delete($id)
    {
        ...
        @unlink('public/assets/sitemaps/' . $sitemap->filename);
        $sitemap->delete();
